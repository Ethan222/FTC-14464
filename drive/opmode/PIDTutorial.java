...
public class PIDTutorial extends LinearOpMode {
    ...
    public void runOpMode() {
         ...
         */
        shooterMotor = hardwareMap.get(DcMotorEx.class, "leftFront");
    ...
    public void PID(double targetVelocity){
        ...
        telemetry.addData(" pidGains.p",  pidGains.p);
        pidGains.i = integral * pidCoeffs.i;
        telemetry.addData(" pidGains.i",  pidGains.i);
        ...
        telemetry.addData(" pidGains.d",  pidGains.d);
